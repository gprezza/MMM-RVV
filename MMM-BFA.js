Module.register("MMM-BFA", {
	...
	getTripRow: function(curTrip, config) {
		...
		trTrip.className = "bfaTripRow";

		// Holds the route (e.g. "2")
		let tdTripRoute = document.createElement("td");
		tdTripRoute.className = "bfaTripColRoute";
		...
		tdTripDestination.className = "bfaTripColDestination";
		...
		tdTripDeparture.className = "bfaTripColDeparture";
